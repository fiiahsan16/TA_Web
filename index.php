    ...
    <body class="hold-transition skin-green-light sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="./" class="logo">
                    <span class="logo-mini"><b>E-CM</b></span>
                    <span class="logo-lg"><b>Sispak</b> Ander</span>
                </a>
                <!-- Header Navbar -->
            ...
            <footer class="main-footer">
                <strong>
                    Copyright ©2022 <i class="fa fa-heart pulse"></i> <b><a style="color: #008cba" href="http://www.mycoding.net" target="_blank">Fii Ahsan Qauly</a></b>
                </strong>
            </footer>
