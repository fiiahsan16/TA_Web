...
$list_data = '';
$q = "select * from komunitas order by id_komunitas desc";
...
if (mysqli_num_rows($q) > 0) {
    while ($r = mysqli_fetch_array($q)) {
		...
		<tr>
		<td></td>
		<td>' . $r['nama_komunitas'] . '</td>
		<td>' . $r['deskripsi_komunitas'] . '</td>
		<td>
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <div class="box-tools">
            <a href="<?php echo $link_update; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Komunitas</a>
        </div>
    </div>
    <div class="box-body">
